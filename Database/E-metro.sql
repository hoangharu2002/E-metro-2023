...
ALTER TABLE [dbo].[LICHSUVE]  WITH CHECK ADD  CONSTRAINT [FK_lsv_ve] FOREIGN KEY([MaVe])
REFERENCES [dbo].[VE] ([MaVE])
GO

ALTER TABLE [dbo].[LICHSUVE] CHECK CONSTRAINT [FK_lsv_ve]
GO

ALTER TABLE [dbo].[TRUNGGIAN]  WITH CHECK ADD  CONSTRAINT [FK_TRUNGGIAN_Ga] FOREIGN KEY([MaGa])
REFERENCES [dbo].[Ga] ([MaGa])
GO

ALTER TABLE [dbo].[TRUNGGIAN] CHECK CONSTRAINT [FK_TRUNGGIAN_Ga]
GO

ALTER TABLE [dbo].[TRUNGGIAN]  WITH CHECK ADD  CONSTRAINT [FK_TRUNGGIAN_TuyenTau] FOREIGN KEY([MaTuyen])
REFERENCES [dbo].[TuyenTau] ([MaTuyen])
GO

ALTER TABLE [dbo].[TRUNGGIAN] CHECK CONSTRAINT [FK_TRUNGGIAN_TuyenTau]
GO

ALTER TABLE [dbo].[TuyenTau]  WITH CHECK ADD  CONSTRAINT [FK_TuyenTau_CongTy] FOREIGN KEY([MaCty])
REFERENCES [dbo].[CongTy] ([MaCty])
GO

ALTER TABLE [dbo].[TuyenTau] CHECK CONSTRAINT [FK_TuyenTau_CongTy]
GO

ALTER TABLE [dbo].[TuyenTau]  WITH CHECK ADD  CONSTRAINT [FK_TuyenTau_VE] FOREIGN KEY([MaVe])
REFERENCES [dbo].[VE] ([MaVE])
GO

ALTER TABLE [dbo].[TuyenTau] CHECK CONSTRAINT [FK_TuyenTau_VE]
GO

ALTER TABLE [dbo].[USER_TRACKING]  WITH CHECK ADD  CONSTRAINT [FK_USER_TRACKING_USER] FOREIGN KEY([ID_user])
REFERENCES [dbo].[USER] ([ID])
GO

ALTER TABLE [dbo].[USER_TRACKING] CHECK CONSTRAINT [FK_USER_TRACKING_USER]
GO